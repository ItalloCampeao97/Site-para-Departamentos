...
# Autor.......: Itallo Eduardo Minucci Campeão - Use! Mas fale quem fez!
# Criação.....: 2014-11-10
...
#  $titulo = ( $acao=="Abertura")  ? "Abertura<br>" : (( $acao=="Incluir")   ? "Inclus&atilde;o" : (( $acao=="Consultar") ? "Consulta" : (( $acao=="Alterar")   ? "Altera&ccedil;&atilde;o" : (( $acao=="Excluir")   ? "Exclus&atilde;o" : (( $acao=="Listar")    ? "Listagem:" : "" ) ) ) ) );
...
{ # Função.....: botoes
  ...
  #################################################################################################################################################################################
  $barra=( ISSET($acao) ) ? "<input type='submit' value='$acao'>" : "";
  $barra=($r) ? $barra."<input type='reset'  value='Limpar'>" : $barra;
  $barra=($p) ? $barra."<input type='button' value='< 1 Pag.' onclick='history.go(-1)'>" : $barra;
...
conecta_my("localhost","lbtar2","root",""); # Com esta linha comentada NÃO se executa a conexão.
